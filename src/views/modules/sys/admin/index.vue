        ...
        >
          ...
          <el-table-column prop label="操作" align="center" width="400">
            <template slot-scope="scope">
              ...
              >审批密码设置</el-button>
              <el-button type="primary" size="mini" @click="reset(scope.$index, scope.row)">审批密码重置</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
    ...
    <div v-show="switchForm" class="form-section">
      ...
      <div class="form-container">
        <el-form ref="form" :model="user" label-width="100px">
          ...
          <el-form-item v-show="showDealers" label="所属服务商">
          ...
          <el-form-item v-show="showOrgSelect" label="所属机构">
...
export default {
  ...
  methods: {
    ...
    getOrgSelected() {
      console.log(this.orgTree, this.user.orgId);
