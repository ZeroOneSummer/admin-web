  ...
  <div class="page-container">
    <div class="show-box">
      ...
      <div class="btn-box">
        ...
        <el-button type="danger" @click="checkup">审查</el-button>
      </div>
      <div class="tb-box">
        <el-table
          ref="dataTable"
        ...
        >
          ...
          <el-table-column prop="refundBean" label="退差金贝数量" align="right" width="120"/>
      ...
      <el-dialog title="退差价审核" :visible.sync="dialogFormVisible" width="25%" top="30vh">
        <el-form :model="form" label-position="left">
          ...
          <el-form-item label="退差金贝数量" label-width="100px">
...
export default {
  ...
  methods: {
    ...
    async submitHandle(){
      let r = await this._fetch('/refundapply/commitApplySecond',{
        method:'POST',
        body:this.form
      });
      if(r.code === 0){
