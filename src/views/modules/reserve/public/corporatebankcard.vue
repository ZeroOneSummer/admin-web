<template>
  <div class="page-container">
    <div v-show="!switchForm" class="show-box">
      ...
      <div class="btn-box">
        <el-button type="primary" icon="el-icon-plus" @click="add">绑卡</el-button>
      </div>
        ...
        >
          ...
          <el-table-column prop label="操作" align="center" width="150">
            <template slot-scope="scope">
              <el-button type="danger" size="mini" @click="updateHandle(scope.$index, scope.row)">解绑</el-button>
              <el-button type="primary" size="mini" @click="withdrawl(scope.$index, scope.row)">提现</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
