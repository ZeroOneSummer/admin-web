        ...
        <el-collapse v-model="activeNames" @change="handleChange">
          <el-collapse-item :title="title" name="1">
            ...
            <div class="query-item btn-item">
              <el-form>
                <el-form-item>
                  <el-button type="success" icon="el-icon-upload" @click="submitUpload">导入名单</el-button>
                </el-form-item>
                <el-form-item>
      ...
      <div class="tb-box">
        ...
        >
          ...
          <el-table-column prop label="操作" align="center">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="aduitHandle(scope.$index, scope.row)">审核</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
